          ...
          <div className="text-left">
            <motion.div variants={itemVariants}>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
                Transforming Education & Enterprise With
                <span className="block bg-gradient-to-r from-yellow-300 to-yellow-400 bg-clip-text text-transparent">Smart Digital Solutions</span>
              </h1>
            </motion.div>
            ...
            >
              Altaif Tech empowers schools, universities, and businesses with seamless, scalable technologies — from mobile apps to advanced LMS and ERP systems.
            </motion.p>
