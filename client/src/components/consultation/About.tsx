          ...
          >
            ...
            <div className="relative bg-white p-8 rounded-3xl shadow-lg border border-primary/10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-4xl font-bold gradient-text">About Altaif Tech</h2>
                  <p className="text-gray-500">Multi-branch Innovation Company</p>
                </div>
              </div>
              
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Altaif Tech is a multi-branch innovation company based in Kuala Lumpur, Indonesia, and Singapore, offering cutting-edge digital solutions across Education Technology, Mobile Apps, and Enterprise Software.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                Our mission is to simplify operations and enhance user experiences through intuitive platforms designed for real-world needs.
              </p>
